 ...
 */
function gca_new_interior_id_safe($string) {
 ...
 */
function gca_new_interior_breadcrumb($breadcrumb) {
  if (!empty($breadcrumb)) {
 ...
 */
function gca_new_interior_comment_wrapper($content, $node) {
 ...
 */
function gca_new_interior_node_submitted($node) {
...
function gca_new_interior_comment_submitted($comment) {
...
function gca_new_interior_menu_local_tasks() {
  $output = '';
 ...
 */
function gca_new_interior_preprocess_block(&$vars, $hook) {
  $block = $vars['block'];
  ...
  if (user_access('administer blocks')) {
    include_once __DIR__ . '/template.block-editing.inc';
